...
namespace GoldBusiness.Data.Migrations
{
    ...
    [Migration("20230531232459_Update-31-05-2023")]
    partial class Update31052023
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoldBusiness.Models.EstadoCuenta", b =>
                {
                    ...
                    b.HasIndex("Cuenta")
                        .HasDatabaseName("IX_EstadoCuenta_Cuenta1");

                    b.HasIndex("Establecimiento", "Cuenta")
                        .IsUnique()
                        .HasDatabaseName("IX_EstadoCuenta_Cuenta");
            ...
            modelBuilder.Entity("GoldBusiness.Models.OperacionesEncabezado", b =>
                {
                    ...
                    b.HasIndex("Transaccion", "NoDocumento", "Cancelado")
                        .IsUnique()
